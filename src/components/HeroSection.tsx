  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        {/* Floating Elements */}
        <div className="absolute top-20 left-10 text-4xl animate-bounce opacity-30 lg:opacity-100" style={{ animationDelay: '0s' }}>💕</div>
        <div className="absolute top-32 right-16 text-3xl animate-bounce opacity-30 lg:opacity-100" style={{ animationDelay: '1s' }}>📊</div>
        <div className="absolute bottom-48 left-20 text-3xl animate-bounce opacity-30 lg:opacity-100" style={{ animationDelay: '2s' }}>🔍</div>
        <div className="absolute bottom-20 right-10 text-4xl animate-bounce opacity-30 lg:opacity-100" style={{ animationDelay: '0.5s' }}>✨</div>
